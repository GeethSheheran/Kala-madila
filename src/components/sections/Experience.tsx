                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                    {experiences.map((exp, idx) => (
                        ...
                        >
                            ...
                            <h3 className="text-2xl font-serif mb-3 group-hover:text-secondary transition-colors duration-300 tracking-tight">
                                {exp.title}
                            </h3>
                            <p className="text-sm text-monochrome-600 font-sans leading-relaxed font-light">
                                {exp.description}
                            </p>
                        </motion.div>
                    ))}
