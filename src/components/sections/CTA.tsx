    ...
    return (
        <section id="contact" className="relative py-32 md:py-60 bg-white overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
                ...
                >
                    <span className="text-[10px] uppercase tracking-[0.5em] text-monochrome-400 font-black">
                ...
                <motion.h2
                    ...
                    className="text-5xl md:text-9xl font-serif mb-12 text-black leading-[1.05] tracking-tight"
                >
                ...
                <motion.p
                    ...
                    className="text-xl md:text-3xl text-monochrome-600 mb-20 font-sans font-extralight max-w-4xl mx-auto leading-relaxed"
                >
                ...
                >
                    <button className="px-20 py-8 bg-black text-white hover:bg-accent hover:text-black transition-all duration-700 rounded-custom text-xs uppercase tracking-[0.4em] font-black shadow-[0_40px_80px_-15px_rgba(0,0,0,0.3)] hover:shadow-[0_45px_90px_-20px_rgba(226,239,112,0.4)] transform hover:scale-105 active:scale-95">
